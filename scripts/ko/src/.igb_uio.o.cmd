cmd_/root/trex-core/scripts/ko/src/igb_uio.o := gcc -Wp,-MD,/root/trex-core/scripts/ko/src/.igb_uio.o.d  -nostdinc -isystem /usr/lib/gcc/aarch64-linux-gnu/5/include  -I./arch/arm64/include -I./arch/arm64/include/generated/uapi -I./arch/arm64/include/generated  -I./include -I./arch/arm64/include/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -Iubuntu/include  -D__KERNEL__ -fno-pie -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -std=gnu89 -fno-PIE -fno-pie -no-pie -mgeneral-regs-only -DCONFIG_AS_LSE=1 -fno-asynchronous-unwind-tables -mpc-relative-literal-loads -fno-delete-null-pointer-checks -O2 --param=allow-store-data-races=0 -Wframe-larger-than=1024 -fstack-protector-strong -Wno-unused-but-set-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-var-tracking-assignments -pg -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -Werror=implicit-int -Werror=strict-prototypes -Werror=date-time -Werror=incompatible-pointer-types -DCC_HAVE_ASM_GOTO  -DMODULE -mcmodel=large  -DKBUILD_BASENAME='"igb_uio"'  -DKBUILD_MODNAME='"igb_uio"' -c -o /root/trex-core/scripts/ko/src/igb_uio.o /root/trex-core/scripts/ko/src/igb_uio.c

source_/root/trex-core/scripts/ko/src/igb_uio.o := /root/trex-core/scripts/ko/src/igb_uio.c

deps_/root/trex-core/scripts/ko/src/igb_uio.o := \
  ...
  /root/trex-core/scripts/ko/src/rte_pci_dev_features.h \
  /root/trex-core/scripts/ko/src/rte_pci_dev_feature_defs.h \
  /root/trex-core/scripts/ko/src/compat.h \

/root/trex-core/scripts/ko/src/igb_uio.o: $(deps_/root/trex-core/scripts/ko/src/igb_uio.o)
